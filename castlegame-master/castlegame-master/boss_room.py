...
def boss_room(item):
    ...
    while boss:
        ...
        ## TODO: Finish scripts here   
            ...
            print("You throw the bomb at the monster with your perfect timing skills. The bomb explodes in its face knocking it backwards.")
            bomb = False
            choice = input(">")
            
        elif "use bomb" in choice and bomb and spear == False:
            print("You throw the bomb at the monster with your perfect timing skills. The bomb explodes in its face knocking it backwards into the pit of lava.")
            ...
            print("You look back towards the big whole and hear a loud BOOM. Popcorn starts to fly out the whole and land on the floor. Congrats you WIN sadly you cant get out")
            bomb = False
            boss = False
